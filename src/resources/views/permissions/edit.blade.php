    ...
    @component('back-project::components.page-title',
      [
        'breadcrumbs' => [
            ...
            [
                'url' => route('bp.permissions.index'),
...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-push-2">
            <a href="{{ route('bp.permissions.index') }}">{!! icon('arrow-left') !!} {{ trans('back-project::menu.Permissions') }}</a>
            @component('back-project::components.panel', ['box_title' => trans('back-project::crud.edit'), 'box_icon' => 'pencil'])
                {!! Form::model($permission, ['class' => 'form-horizontal', 'method' => 'post', 'route' => ['bp.permissions.update', $permission->id]]) !!}
                {{ method_field('PUT') }}
