...
@section('content')
    <div class="row">
        <div class="col-md-9 col-md-push-1">
            <a href="{{ route('media.index') }}">{!! icon('arrow-left') !!} {{ trans('back-project::menu.All Media') }}</a>
            @component('back-project::components.panel', ['box_title' => trans('back-project::crud.edit'), 'box_icon' => 'pencil'])
                {!! Form::model($attachment, ['class' => 'form-horizontal', 'method' => 'post', 'route' => ['media.update', $attachment->id]]) !!}
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-md-4">
